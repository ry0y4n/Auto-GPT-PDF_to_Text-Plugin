...
class AutoGPTPDFToText(AutoGPTPluginTemplate):
    """
    PDF-to-Text integrations using PyMuPDF
    """

    def __init__(self):
        super().__init__()
        self._name = "autogpt-pdf2txt"
        self._version = "0.1.0"
        self._description = "PDF-to-Text integrations using PyMuPDF"
